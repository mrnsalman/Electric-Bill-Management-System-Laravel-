...
<head>
    ...
    <![endif]-->
    <title>Electric Bill Invoice</title>
...
<body>
                                <div class="col-lg-11 col-md-11 col-sm-11" style="font-family: verdana; font-size:11px;margin:0px;padding:0px; background:url('/images/dpdc-t.png') no-repeat center 380px;margin-top: 30px;">
                                    <div style="width: 98%;background-color: #fff; opacity: .9;margin-left: 5px;">
                                        ...
                                        <div style="color:#257590; vertical-align: top; text-align:right; font-size: 13px;font-family: 'Times New Roman';margin-bottom: 5px">BILL ID : <span style="color:#696957;">{{$invoiceBill->bill_id}}</span></div>
                                        ...
                                        <table style="border:1px solid #4d99b3;margin:0px 0px 2px 20px;color:#257590;width:100%;font-size:12px;" cellpadding="0" cellspacing="0">
                                            <tr>
                                                <td style="padding:4px 10px;vertical-align: top;" width="50%">
                                                    ...
                                                    <div style="color:#696957;">{{$invoiceBill->shop->shop_owner}}</div><br>

                                                    <div style="color:#696957;">

                                                        <div>{{$invoiceBill->shop->owner_address}}</div><br>

                                                    </div>

                                                    <div style="color:#696957;">

                                                        <div>{{$invoiceBill->shop->owner_contact}}</div>
                                                ...
                                                <td style="border-left: 1px solid #4d99b3;padding: 0px;">
                                                    <table style="width:100%;" cellpadding="0" cellspacing="0">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td colspan="2" style="text-align: center;color:#696957;">{{$invoiceBill->year}}</td>
                                                            <td style="text-align: center;color:#696957;">{{date('d/m/Y', strtotime($invoiceBill->created_at))}}</td>
                                                        ...
                                                        <tr>
                                                            <td style="text-align: center;padding: 8px;color:#696957;">{{$invoiceBill->shop->shop_no}}</td>
                                                            <td colspan="2" style="text-align: center;color:#696957;">{{$invoiceBill->shop->shop_name}}</td>
                                                            <td style="text-align: center;color:#696957;">{{$invoiceBill->last_date}}</td>
					...
					<span style="width:100%;display: inline-block;text-align: right">
					      <div style="padding-bottom: 5px">{{$invoiceBill->current_unit}}</div>
					      <div style="padding-bottom: 5px">{{$invoiceBill->previous_unit}}</div>
					       <div style="padding-bottom: 5px">{{$invoiceBill->used_unit}}</div>
					</span>
                                                    ...
                                                    <table style="color:#257590;width:100%;" cellpadding="0" cellspacing="0">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td style="border-top:1px solid #4d99b3;border-left:1px solid #4d99b3;color:#696957;padding:4px;vertical-align: top;text-align: right;width: 15%;">
                                                                ...
                                                                <div style="padding-bottom: 5px">        {{$invoiceBill->unit_rate}}.00</div>
                                                                <div style="padding-bottom: 5px">          {{$invoiceBill->exclude_fee}}.00</div>
                                                                <div style="padding-bottom: 5px">           {{$invoiceBill->exclude_due}}.00</div>
                                                                <br>
                                                                <div style="padding-bottom: 5px">           {{$invoiceBill->payment_status}}</div>
                                                                ...
                                                                <table cellpadding="0" cellspacing="0" width="100%">
                                                                    <tr>
                                                                        <td style="border-bottom:1px solid #4d99b3; color:#696957; padding:5px;text-align: right;">
                                                                            <div style="padding-bottom: 5px">{{$invoiceBill->previous_due}}.00</div>
                                                                            <div style="padding-bottom: 5px">{{$invoiceBill->additional_fee}}.00</div>
                                                                            <div style="padding-bottom: 17px"></div>
                                                                    </tr>
                                                                    <tr>
                                                                        <td style="border-top:1px solid #4d99b3;border-right:1px solid #4d99b3;border-left:1px solid #4d99b3;padding:4px;vertical-align: top;background-color: #FFCCCC; text-align: right;color:#696957;">
                                                                            ...
                                                                            <div style="padding: 5px">{{$invoiceBill->total_amount}}.00</div>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td style="border-top:1px solid #4d99b3;border-right:1px solid #4d99b3;border-left:1px solid #4d99b3;padding:4px;vertical-align: top;background-color: #CCF2FF;text-align:right;color:#696957;">
                                                                            <div style="padding: 5px">{{$invoiceBill->after_date}}.00</div>
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                                            </td>
                                                    ...
                                                    <table style="width:100%;" cellpadding="0" cellspacing="0">
                                                        ...
                                                        <tr>
                                                            <td style="text-align: center; padding: 8px;color:#696957;border-left:0px;border-bottom: 0px;">
                                                                {{$invoiceBill->month}}							</td>
                                                            <td colspan="2" style="text-align: center;color:#696957;border-left:0px;border-bottom: 0px;">{{$invoiceBill->year}}</td>
                                                            <td style="text-align: center;color:#696957;border-left:0px;border-bottom: 0px;">{{date('d/m/Y', strtotime($invoiceBill->created_at))}}</td>
                                                            <td style="text-align: center;color:#696957;border-left:0px;border-bottom: 0px;">{{$invoiceBill->last_date}}</td>
                                                        ...
                                                        <tr>
                                                            <td style="text-align: center;padding: 8px;color:#696957;border-left:0px;border-bottom: 0px;">{{$invoiceBill->shop->shop_no}}</td>
                                                            <td colspan="2" style="text-align: center;color:#696957;border-left:0px;border-bottom: 0px;">{{$invoiceBill->shop->shop_name}}</td>
                                                            <td style="text-align: center;color:#696957;border-left:0px;border-bottom: 0px;">{{$invoiceBill->total_amount}}.00</td>
                                                            <td style="text-align: center;color:#696957;border-left:0px;border-bottom: 0px;">{{$invoiceBill->after_date}}.00</td>
