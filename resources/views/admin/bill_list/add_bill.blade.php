            ...
            <div class="row">
                ...
                <div class="offset-2 col-md-8">
                    ...
                    <div class="card card-default">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        {{Form::open(['route'=>'newBill','method'=>'post','class'=>'form-horizontal', 'data-parsley-validate' => ''])}}
                        <div class="card-body">
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    'October'=>'October','November'=>'November','December'=>'December'],'0',['class'=>'form-control','id'=>'month', 'required' => ''])}}
                                    {{Form::hidden('shop_id',$shop->id,['class'=>'form-control','id'=>'shop_id'])}}
                                    {{Form::hidden('shop_floor',$shop->floor,['class'=>'form-control','id'=>'shop_floor'])}}
                                    ...
                                    <span class="text-danger text-bold">{{$errors->has('shop_floor') ? $errors->first('shop_floor') : ''}}</span>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    '2028'=>'2028','2029'=>'2029','2030'=>'2030'],'0',['class'=>'form-control','id'=>'year', 'required' => ''])}}
                                    {{Form::hidden('bill_id','',['class'=>'form-control','id'=>'bill_id'])}}
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    {{Form::text('current_unit','',['class'=>'form-control','placeholder'=>'Enter current unit','id'=>'current_unit', 'required' => ''])}}
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    {{Form::text('previous_unit','',['class'=>'form-control','placeholder'=>'Enter previous unit','id'=>'previous_unit', 'required' => ''])}}
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    {{Form::text('used_unit','',['class'=>'form-control','placeholder'=>'Enter used unit','id'=>'used_unit', 'required' => ''])}}
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    {{Form::text('unit_rate','',['class'=>'form-control','placeholder'=>'Enter unit rate','id'=>'unit_rate', 'required' => ''])}}
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    {{Form::text('previous_due','',['class'=>'form-control','placeholder'=>'Enter previous due','id'=>'previous_due', 'required' => ''])}}
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    {{Form::text('additional_fee','',['class'=>'form-control','placeholder'=>'Enter additional fee','id'=>'additional_fee', 'required' => ''])}}
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    {{Form::hidden('total_amount_due','',['class'=>'form-control','placeholder'=>'Enter total amount','id'=>'total_amount_due'])}}
                                    {{Form::hidden('exclude_fee','',['class'=>'form-control','placeholder'=>'Enter total amount','id'=>'exclude_fee'])}}
                                    {{Form::hidden('total_amount_add_fee','',['class'=>'form-control','placeholder'=>'Enter total amount','id'=>'total_amount_add_fee'])}}
                                    {{Form::text('total_amount','',['class'=>'form-control','placeholder'=>'Enter total amount','id'=>'total_amount', 'required' => ''])}}
                                    {{Form::hidden('after_date','',['class'=>'form-control','placeholder'=>'Enter total amount','id'=>'after_date'])}}
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    {{Form::text('paid_amount','',['class'=>'form-control','placeholder'=>'Enter paid amount','id'=>'paid_amount', 'required' => ''])}}
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    {{Form::text('due_amount','',['class'=>'form-control','placeholder'=>'Enter due amount','id'=>'due_amount', 'required' => ''])}}
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    {{Form::text('payment_status','',['class'=>'form-control disabled','placeholder'=>'Enter payment status','id'=>'payment_status', 'required' => ''])}}
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    {{Form::text('last_date',date('15/m/Y'),['class'=>'form-control disabled','placeholder'=>'Set last pay date','id'=>'datepicker', 'required' => ''])}}
